package cn.zurish.index12306.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(cn.zurish.index12306.framework.starter.log.annotation.ILog) || @annotation(cn.zurish.index12306.framework.starter.log.annotation.ILog)")
