package cn.zurish.index12306.biz.userservice.controller;

import cn.zurish.index12306.framework.starter.convention.result.Result;
...
import cn.zurish.index12306.biz.userservice.service.PassengerService;
import cn.zurish.index12306.framework.starter.idempotent.annotation.Idempotent;
import cn.zurish.index12306.framework.starter.idempotent.enums.IdempotentSceneEnum;
import cn.zurish.index12306.framework.starter.idempotent.enums.IdempotentTypeEnum;
import cn.zurish.index12306.framework.starter.user.core.UserContext;
import cn.zurish.index12306.framework.starter.web.Results;
...
public class PassengerController {
    ...
    @Idempotent(
            ...
            key = "T(cn.zurish.index12306.framework.starter.user.core.UserContext).getUsername()",
